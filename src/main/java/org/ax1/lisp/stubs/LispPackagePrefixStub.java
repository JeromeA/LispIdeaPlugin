...
public class LispPackagePrefixStub extends LispStringDesignatorStub<LispPackagePrefix> {
  ...
  protected LispPackagePrefixStub(@Nullable StubElement parent, IStubElementType elementType, String packageName,
                                  BaseLispElement.Type type) {
    super(parent, elementType, null, packageName, type);
  }
