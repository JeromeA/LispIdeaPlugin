...
public class LispStringDesignatorBase<T extends StubElement> extends StubBasedPsiElementBase<T> implements LispStringDesignator {
  ...
  private static final Set<String> KEYWORDS =
      Set.of("DECLARE", "DEFCONSTANT", "DEFINE-CONDITION", "DEFPACKAGE", "DEFPARAMETER", "DEFMACRO", "DEFUN", "DEFVAR",
          "DO", "DOLIST", "DOSYMBOLS", "EVAL-WHEN", "FLET", "IF", "IGNORE", "IN-PACKAGE", "INCF", "LAMBDA",
          "LET", "LET*", "LOOP", "PROCLAIM", "RETURN", "SETF", "SETQ", "SPECIAL", "THROW", "UNLESS", "WHEN");
